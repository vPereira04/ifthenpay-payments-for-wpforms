 ...
 */
final class IfthenpayDarkTheme {

	private const SLUG = 'ifthenpay-dark';
	...
	private function theme_definition(): array {
		return [
			...
			'settings' => [
				...
				'fieldBorderSize'      => '1px',
				'fieldBackgroundColor' => '#001b2d',
				'fieldBorderColor'     => '#00a7e2',
				'fieldTextColor'       => '#ffffff',
				'fieldMenuColor'       => '#001b2d',
				'labelSize'            => 'medium',
				'labelColor'           => '#ffffff',
				'labelSublabelColor'   => '#00a7e2',
				'labelErrorColor'      => '#FF6467',
				'buttonSize'           => 'medium',
				'buttonBorderStyle'    => 'none',
				'buttonBorderSize'     => '1px',
				'buttonBorderRadius'   => '8px',
				'buttonBorderColor'    => '#00a7e2',
				'buttonBackgroundColor' => '#00a7e2',
				'buttonTextColor'      => '#ffffff',
				'pageBreakColor'       => '#00a7e2',
				...
				// Grid fading from crisp (top) to hidden (bottom) — baked directly into
				// assets/images/grid-pattern.svg as a pattern fill + gradient overlay, since a
				// flat repeating tile can't vary in intensity across the form (every tile is
				// identical). Rendered once, scaled, not tiled — backgroundImage/
				// backgroundSizeMode/backgroundWidth/backgroundHeight are theme-editor UI
				// state only (see CSSVars.php's actual container rule, which only ever reads
				// backgroundColor/backgroundUrl/backgroundPosition/backgroundRepeat/
				// backgroundSize), so only those five drive real output.
				...
				'backgroundUrl'        => 'url(' . IFTP_PBL_URL . 'assets/images/grid-pattern.svg' . ')',
			],
		];
	}
}
